...
type FormState = { ID_PESSOA: string; AREA_ATUACAO: string };

const formVazio = (): FormState => ({ ID_PESSOA: "", AREA_ATUACAO: "" });
...
export default function FornecedoresPage() {
  ...
  const confirmarExclusao = async () => {
    if (!excluirId) return;
    try {
      await api.delete(`/fornecedores/${excluirId}`);
              ...
              <TableRow key={f.ID_FORNECEDOR}>
                ...
                <TableCell className="text-right">
                  ...
                  <Button
                    ...
                    onClick={() => setExcluirId(f.ID_FORNECEDOR)}
                  >
